...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | StyloCoin - React.js Admin Dashboard Template"
        description="This is React.js Videos page for StyloCoin - React.js Tailwind CSS Admin Dashboard Template"
      />
